...
server.stdout.on('data', (data) => {
  ...
  if (data.indexOf('Serving Spaniel Test App') > -1 && !test) {
    ...
    // test = spawn('./node_modules/mocha/bin/mocha', ['--compilers', 'js:babel-core/register', 'test/headless/specs/sample-spec.js', '--timeout', '3000']);

    // TODO change this back to test against entire specs/**/*.js
    test = spawn('./node_modules/mocha/bin/mocha', ['test/headless/setup.js','--compilers', 'js:babel-register', 'test/headless/specs/sample-spec.js', '--timeout', '3000']);
